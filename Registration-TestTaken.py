...
with col11:
  ...
  st.markdown("Original data set include 6694 registraion and 7105 test-taken records worldwide for fiscal years 2021 to 2023 (2020/10 to 2023/2). The following two type of records were removed in the clean data set: 1. 464 records with no volume; 2. 322 records in 2023 March to September. Therefore, there are 13013 records in the clean data set. ")
...
labels = ['(<1000)','[1000,3000)','[3000-6000)','[6000-9000)','[9000-12000)','[12000-15000)','[15000-30000)','[30000-40000)','[40000-50000)','[50000-60000)','[>=60000)']
